...
public class GameController {
    ...
    @GetMapping("/start")
    public Map<String, Object> startGame(@RequestParam(value="test1") String testEnv) {
    ...
    public Map<String, Object> yesButton() {
        ...
        //last to ask
            ...
            game.addQuestPlayers();
            game.createQuest();
            System.out.println("Quest created");
            int stage = game.getCurrentStage()+1;
    ...
    public Map<String, Object> discardCards(@RequestBody ArrayList<String> cards) {
        ...
        if(game.getSponsorPlayer() != null && game.getSponsorPlayer().getHand().size() > 12) {
            System.out.println("In sponsor trimming, sponsor name " + game.getSponsorPlayer().getName());
            //trimming hand by sponsor, return response of current player and message to return

            if (game.getSponsorTrim()) {
                System.out.println("showing means sponsor trim true.");
                System.out.println("Sponsor trimming");
                ...
                game.clearSponsor();
                System.out.println("Sponsor player cleared " + game.getSponsorPlayer());
