...
public class Menu {
            ...
            if (event.equals("Plague")) {
                ...
                if (!findingSponsor(event)) {
                    ...
                    if (participantIsEmpty()) {
                        ...
                        buildQuest(event, sponsorplayer, participants);
                        //game played
                        quest(event);
                    }
                }
    ...
    //quest completed then ..., or failed
    public void quest(String event) {
        if (stageFight()) {
            //update shields
    ...
    //detect no participants
    public boolean participantIsEmpty() {
        return participants.isEmpty();
    }

    //update shields to winner participants
    ...
    //participant adds card at stage
    ...
    //sponsor draw card - after quest
    public void sponsorDrawAdventureCard(Player sponsorplayer, int times) {
    ...
    //quest build by the sponsor
    public void buildQuest(String event, Player sponsorplayer, List<Player> participants) {
